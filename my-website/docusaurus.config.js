...
const config = {
  ...
  url: 'https://github.com/SergionJuice/t-bank.git', // Адрес gitlab pages, обычно https://<username>.github.io
  baseUrl: 't-bank', // Базовый url, обычно название репозитория
  organizationName: 'SergionJuice', // Имя GitHub пользователя
  projectName: 't-bank', // Имя репозитория
